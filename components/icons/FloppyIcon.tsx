...
export function FloppyIcon({ size = 24, color = '#141B34', strokeWidth = 1.5 }: StrokeIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <Path d="M10 7H14" stroke={color} strokeWidth={strokeWidth} strokeLinejoin="round" />
      <Path
