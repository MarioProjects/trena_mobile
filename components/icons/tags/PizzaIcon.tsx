...
export function PizzaIcon({ size = 24, color = '#141B34', strokeWidth = 1.5 }: StrokeIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        ...
        strokeWidth={strokeWidth}
      />
      <Path d="M13.008 11H12.999" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <Path
