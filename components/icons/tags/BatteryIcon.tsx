...
export function BatteryIcon({ size = 24, color = '#141B34', strokeWidth = 1.5 }: StrokeIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        ...
        strokeLinecap="round"
      />
      <Path d="M6 10V14" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <Path d="M9 10V14" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <Path d="M12 10V14" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <Path d="M15 10V14" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    </Svg>
  );
}
